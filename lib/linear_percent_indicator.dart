...
class LinearPercentIndicator extends StatefulWidget {
  ...
  }) : this._progressColor = progressColor ?? Colors.red,
       super(key: key) {
...
class _LinearPercentIndicatorState extends State<LinearPercentIndicator>
  ...
  void initState() {
    WidgetsBinding.instance?.addPostFrameCallback((_) {
      if (mounted) {
        setState(() {
          _containerWidth = _containerKey.currentContext?.size?.width ?? _containerWidth;
          _containerHeight = _containerKey.currentContext?.size?.height ?? _containerHeight;
          _indicatorWidth = _keyIndicator.currentContext?.size?.width ?? _indicatorWidth;
          _indicatorHeight = _keyIndicator.currentContext?.size?.height ?? _indicatorHeight;
        });
      }
    });
    if (widget.animation) {
...
class LinearPainter extends CustomPainter {
  ...
  }) : this.linearStrokeCap = linearStrokeCap ?? LinearStrokeCap.butt {
