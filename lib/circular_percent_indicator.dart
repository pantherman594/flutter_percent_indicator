    ...
    if (widget.animation) {
      ...
      _animation = Tween(begin: 0.0, end: widget.percent).animate(
        CurvedAnimation(parent: _animationController!, curve: widget.curve),
          ...
          setState(() {
            _percent = _animation?.value ?? _percent;
          });
...
class CirclePainter extends CustomPainter {
  ...
  CirclePainter(
      ...
      this.arcType,
      this.maskFilter,
      this.rotateLinearGradient}) : this.circularStrokeCap = circularStrokeCap ?? CircularStrokeCap.round {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (linearGradient != null) {
      if (rotateLinearGradient == true && progress > 0) {
        double correction = 0;
